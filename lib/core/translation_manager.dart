...
class TranslationManager {
  static const Map<String, Map<String, String>> _localizedStrings = {
    'en': {
      ...
      'rank_ascension_title': '[ ⚔️ RANK ASCENSION ]',
      'rank_ascension_desc': 'Congratulations Hunter! Your rank has ascended to the next tier.',
      'rank_reward_ap': 'Attribute Points (AP)',
      'rank_reward_exp': 'Experience (EXP)',
      'rank_reward_gold': 'Gold',
      'rank_btn_auto_allocate': '⚡ AUTO-ALLOCATE STATS',
      'rank_btn_manual_allocate': '💎 I WILL ALLOCATE MANUALLY',
      'rank_toast_allocated': '⚡ STATS UPGRADED',
      'rank_toast_saved': '💎 AP added to your account! You can allocate them from the Status screen.',
      'status_auto_allocate_toggle': 'Auto-Allocate Stats',
      'status_auto_allocate_hint': 'Automatically allocates earned AP according to your combat build',
      ...
      // Progress Analytics
      'analytics_title': '[ SYSTEM // PROGRESS & ANALYTICS ]',
      'analytics_tab_weight': 'WEIGHT TREND',
      'analytics_tab_workout': 'WORKOUT VOLUME',
      'analytics_tab_diet': 'NUTRITION TREND',
      'analytics_tab_strength': '1RM STRENGTH',
      'analytics_current_weight': 'CURRENT WEIGHT',
      'analytics_target_weight': 'TARGET WEIGHT',
      'analytics_weight_delta': 'NET CHANGE',
      'analytics_total_workout_time': 'TOTAL WORKOUT',
      'analytics_cleared_raids': 'CLEARED RAIDS',
      'analytics_total_burned': 'TOTAL BURNED',
      'analytics_avg_calories': 'AVG CALORIES',
      'analytics_target_adherence': 'GOAL ADHERENCE',
      'analytics_total_strength': 'TOTAL LIFT',
      'analytics_bodyweight_ratio': 'POWER RATIO',
      'analytics_no_weight_data': 'No weight history logged yet. Log your weight in Status to generate trend curves.',
      'analytics_no_workout_data': 'No dungeon raid logs found yet. Complete workouts to visualize volume.',
      'analytics_no_diet_data': 'No meal archive found yet. Complete daily nutrition logs to track macros.',
      'analytics_power_tier': 'HUNTER POWER TIER',
      'analytics_open_btn': 'ANALYTICS & PROGRESS',
      'cal_diet_logged': 'DIET LOGGED',
      'cal_all_cleared': 'FULL DAY CLEARED',
    },
    'tr': {
      // Welcome Screen
      ...
      'rank_ascension_title': '[ ⚔️ RÜTBE YÜKSELİŞİ // RANK ASCENSION ]',
      'rank_ascension_desc': 'Tebrikler Avcı! Rütben bir üst kademeye yükseldi.',
      'rank_reward_ap': 'Stat Puanı (AP)',
      'rank_reward_exp': 'Deneyim (EXP)',
      'rank_reward_gold': 'Altın',
      'rank_btn_auto_allocate': '⚡ OTOMATİK STATLARA ATASIN',
      'rank_btn_manual_allocate': '💎 PUANLARI BEN DAĞITACAĞIM',
      'rank_toast_allocated': '⚡ STATLAR GÜNCELLENDİ',
      'rank_toast_saved': '💎 AP puanları hesabına eklendi! Durum ekranından dağıtabilirsin.',
      'status_auto_allocate_toggle': 'Otomatik Stat Dağıtımı',
      'status_auto_allocate_hint': 'Kazanılan AP puanlarını antrenman stiline göre otomatik dağıtır',
      ...
      // Progress Analytics
      'analytics_title': '[ SİSTEM // GELİŞİM & İLERLEME ANALİZİ ]',
      'analytics_tab_weight': 'KİLO TRENDİ',
      'analytics_tab_workout': 'İDMAN HACMİ',
      'analytics_tab_diet': 'BESLENME TRENDİ',
      'analytics_tab_strength': '1RM KUVVET',
      'analytics_current_weight': 'GÜNCEL KİLO',
      'analytics_target_weight': 'HEDEF KİLO',
      'analytics_weight_delta': 'NET DEĞİŞİM',
      'analytics_total_workout_time': 'TOPLAM İDMAN',
      'analytics_cleared_raids': 'BİTEN ZİNDAN',
      'analytics_total_burned': 'YAKILAN KALORİ',
      'analytics_avg_calories': 'ORTALAMA KALORİ',
      'analytics_target_adherence': 'HEDEF UYUMU',
      'analytics_total_strength': 'TOPLAM KALDIRIŞ',
      'analytics_bodyweight_ratio': 'GÜÇ ORANI',
      'analytics_no_weight_data': 'Henüz tartı geçmişi bulunamadı. Tartı güncellemeleri yaptıkça gelişim eğriniz burada çizilecektir.',
      'analytics_no_workout_data': 'Henüz tamamlanmış zindan kaydı yok. İdman yaptıkça hacim grafiğiniz oluşacaktır.',
      'analytics_no_diet_data': 'Henüz beslenme arşivi oluşmadı. Günlük öğünlerinizi kaydettikçe kalori trendiniz listelenecektir.',
      'analytics_power_tier': 'AVCI GÜÇ KADEMESİ',
      'analytics_open_btn': 'İSTATİSTİK & İLERLEME',
      'cal_diet_logged': 'DİYET KAYDEDİLDİ',
      'cal_all_cleared': 'EKSİKSİZ GÜN',
    }
  };
